...
(function (root, factory) {
  ...
  function initAllProperties(properties, element, attrs, ngModelController, dynamicNumberStrategy){
    ...
    var integerPart = initIntegerPart(properties.numInt !== undefined ? properties.numInt : strategy.numInt, 50);
    ...
    var isNegativeNumber = initIsNegative(properties.numNeg !== undefined ? properties.numNeg : strategy.numNeg, false);
